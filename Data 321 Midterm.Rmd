...
```{r ttest/anova}
# Tests to quantify similarity btw sample means and random means
...
full_formula <- quality ~ voli_acid + sugar + pH + sulfates + alcohol
...
print(paste0("Cohen's f is: ", round(f2,4)))
summary(lm_full)
```
...
feat <- c("alcohol", "voli_acid", "sulfates", "sugar", "pH")
